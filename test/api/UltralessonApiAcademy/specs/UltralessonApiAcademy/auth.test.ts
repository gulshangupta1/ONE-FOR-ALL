...
import { SignUpResponseBody, signUpResponseSchema } from "../../models/response/UltralessonApiAcademy/auth/signUp.response";
...
import { LoginResponseBody, loginResponseSchema } from "../../models/response/UltralessonApiAcademy/auth/login.response";
