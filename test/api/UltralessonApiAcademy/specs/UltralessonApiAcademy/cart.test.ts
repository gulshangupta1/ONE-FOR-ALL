...
import { CreateCartResponseBody, createCartResponseSchema } from "../../models/response/UltralessonApiAcademy/cart/createCart.response";
import { DeleteCartResponseBody, deleteCartResponseSchema } from "../../models/response/UltralessonApiAcademy/cart/deleteCart.response";
import { GetCartResponseBody, getCartResponseSchema } from "../../models/response/UltralessonApiAcademy/cart/getCart.response";
...
describe(specName, () => {
    ...
    it("Should be able to create a cart", async () => {
        ...
        expect(ResponseUtil.isValidateSchema(createCartResponseBody, createCartResponseSchema), "Invalid schema").to.be.true;
    });
    ...
    it("Should be able to delete the cart", async () => {
        ...
        expect(ResponseUtil.isValidateSchema(deleteCartResponseBody, deleteCartResponseSchema), "Invalid schema").to.be.true;
    });
    ...
    it("Should be able to get cart", async () => {
        ...
        expect(ResponseUtil.isValidateSchema(getCartResponseBody, getCartResponseSchema), "Invalid schema").to.be.true;
    });
});